                                    ...
                                    <div class="row">
                                        <div class="col-12 item item-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="enable" name="publish_affiliation" placeholder="Affiliation" value="{{$article->user->affiliation}}" required>
                                        ...
                                        <div class="col-12 item item-2">
                                            <div class="form-group disabled">
                                                ...
                                                <input type="text" class="enable" name="publish_firstname" placeholder="First Name" value="{{$article->user->first_name}}" required disabled>
                                                <span class="validationMsg"></span>
                                            </div>
                                        </div>
                                        <div class="col-12 item item-2">
                                            <div class="form-group disabled">
                                                ...
                                                <input type="text" class="enable" name="publish_lastname" placeholder="Last Name" value="{{$article->user->last_name}}" required disabled>
                                                <span class="validationMsg"></span>
                                            </div>
                                        </div>
                                        <div class="col-12 item item-2">
                                            <div class="form-group disabled">
                                                <label>Degree</label>
                                                <input type="text" class="enable" name="publish_degree" placeholder="Enter your Degree" value="{{$article->user->degree}}" required disabled>
                                                <span class="validationMsg"></span>
                                            </div>
                                        </div>
                                        <div class="col-12 item item-2">
                                            <div class="form-group disabled">
                                                ...
                                                <input type="text" class="enable" name="publish_orcid" placeholder="ORCID Number" value="{{$article->user->ORCID_number}}" required disabled>
                                                <span class="validationMsg"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group authors">
                                                ...
                                                <div class="single-author">
                                                    ...
                                                    <div class="single-author-inputs">
                                                        ...
                                                        <input type="text" class="add-author" name="publish_addAuthorName[]" placeholder="Author Name" value="{{$author->name}}" required>
                                                        <input type="text" class="add-author" name="publish_addAuthorTitle[]" placeholder="Author Title" value="{{$author->title}}" required>
                                                        <input type="text" class="add-author" name="publish_addAuthorAffiliation[]" placeholder="Affiliation" value="{{$author->affiliation}}" required>
                                                        @endforeach
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12 item item-3">
                                                <div class="form-group disabled">
                                                    ...
                                                    <input type="text" class="enable-next input" name="publish_title" placeholder="Title" value="{{$article->title}}" required disabled>
                                                    <span class="validationMsg"></span>
                                                </div>
                                            </div>
                                        <div class="col-12 item item-3">
                                        ...
                                        <div class="col-12 item item-3">
                                            <div class="form-group disabled">
                                                ...
                                                <input type="text" class="enable-next input" name="publish_corresponding" placeholder="Email" value="{{$article->corresponding_author}}" required disabled>
                                                <span class="validationMsg"></span>
                                            </div>
                                        </div>
                                        <div class="col-12 item item-3 article-content-item">
                                            <div class="form-group disabled">
                                                ...
                                                <div class="rich-text-editor">
                                                    <textarea class="summernote" name="abstract" placeholder="Abstract" required>{{$article->abstract}}</textarea>
                                                    <span class="disable rich-disable"></span>
                                                </div>
                                                <textarea name="keywords" class="enable-text" placeholder="Keywords" disabled required>{{$article->keywords}}</textarea>
                                                <div class="rich-text-editor">
                                                    <textarea class="summernote" name="intro" placeholder="Intro" required>{{$article->intro}}</textarea>
                                                    <span class="disable rich-disable"></span>
                                                </div>
                                                <div class="rich-text-editor">
                                                    <textarea name="additionalInfo" class="summernote" placeholder="Additional Info" required>{{$article->additional_info}}</textarea>
                                                    <span class="disable rich-disable"></span>
                                                </div>
                                                <div class="rich-text-editor">
                                                    <textarea name="Reference" class="summernote" placeholder="Reference" required>{{$article->reference}}</textarea>
                                                    <span class="disable rich-disable"></span>
                                                </div>
                                                ...
                                                <p>{{$article->author_conflict}}</p>
                                                <div class="text-and-file">
                                                    <div class="text col-md-6 col-sm-12">
                                                        <textarea class="enable-text" name="financialDisclosure" placeholder="Financial Disclosure" disabled required>{{$article->financial_disclosure}}</textarea>
                                                    </div>
                                                    ...
                                                    <p>{{$article->financial_disclosure_file}}</p>
                                                </div>
                                                <textarea class="enable-text" name="ethicsCommunity" placeholder="Ethics Community" disabled required>{{$article->ethics_community}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
