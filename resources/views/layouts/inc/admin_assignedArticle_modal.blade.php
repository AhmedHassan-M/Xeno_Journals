...
<div class="modal fade article_modal" id="assignedArticleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" id="article_body">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="exampleModalLongTitle">Assigned Article</h5>
            </div>
                                ...
                                <div id="authors-area" class="tab-content col-12">
                                    <div class="row tab-pane fade show active" id="pills-author_info" role="tabpanel" aria-labelledby="pills-author_info-tab">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="item col-12">
                                                    <h5 class="title">Author Title Mr/Mrs</h5>
                                    ...
                                    <div class="row tab-pane fade" id="pills-article_info" role="tabpanel" aria-labelledby="pills-article_info-tab">
                                        <div class="col-12">
                                            ...
                                            <div class="row">
                                                <div class="item col-12">
                                                    <h5 class="title">Approval Date</h5>
                                                    <p class="text" id="approval_date">Lorem Ipsum</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn reject-btn article_to_reject">Back to Data Entry</button>
                <button type="button" class="btn approve-btn">Publish</button>
            </div>
            @elseif($_SERVER['REQUEST_URI'] == '/admin/articles/assigned')
                <div class="modal-footer">
                    <button type="button" class="btn reject-btn article_to_reject">Back to Data Entry</button>
                    <button type="button" onclick="publish()" class="btn publish-btn">Publish</button>
                </div>
            @endif
        </div>
        <form method="POST" action="/admin/back-to-dataentry" class="modal-content d-none" id="reject_step">
            {{ csrf_field() }}
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="exampleModalLongTitle">Back To Assigned Article</h5>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="item-step col-12">
                                    <h5 class="title">Write Notes</h5>
                                    <textarea name="backToDataEntry_reasion" required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
