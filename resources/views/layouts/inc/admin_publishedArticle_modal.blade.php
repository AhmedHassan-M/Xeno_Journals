...
<div class="modal fade article_modal" id="publishedArticleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" id="article_body">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="exampleModalLongTitle">Published Article</h5>
            </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="row">
                                                <div class="item col-12">
                                                    ...
                                                    <p class="text" id="publish_date">Lorem Ipsum</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <!-- <div class="modal-footer">
                <button type="button" class="btn reject-btn">Delete This Article</button>
            </div> -->
        </div>
    </div>
</div>
