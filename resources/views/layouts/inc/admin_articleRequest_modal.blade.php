...
<div class="modal fade article_modal" id="articleRequestModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" id="article_body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="row">
                                <div class="item col-12">
                                    ...
                                    <p class="text" id="affiliation_text">Lorem Ipsum</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12">
                            <div class="row">
                                <div class="item col-12">
                                    ...
                                    <p class="text" id="degree_text">Lorem Ipsum</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12">
                            <div class="row">
                                <div class="item col-12">
                                    ...
                                    <p class="text" id="firstname_text">Lorem Ipsum</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12">
                            <div class="row">
                                <div class="item col-12">
                                    ...
                                    <p class="text" id="correspondingAuthor_text">Lorem Ipsum</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="row">
                                <div class="item col-12">
                                    ...
                                    <p class="text" id="lastname_text">Lorem Ipsum</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 article-details">
                            ...
                            <div class="row details-panes">
                                <div id="authors-area" class="tab-content col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="item col-12">
                                                    ...
                                                    <p class="text" id="details_name_text">Lorem Ipsum</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="item col-12">
                                                    ...
                                                    <p class="text" id="details_title_text">Lorem Ipsum</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="item col-12">
                                                    <h5 class="title">Affiliation</h5>
                                                    <p class="text" id="details_affiliation_text">Lorem Ipsum</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="item col-12">
                                                    ...
                                                    <p class="text" id="details_type_text">Lorem Ipsum</p>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="item col-12">
                                                    <h5 class="title">Submission Date</h5>
                                                    <p class="text" id="submission_date">Lorem Ipsum</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="item col-12">
                                                    ...
                                                    <p class="text" id="details_abstract_text">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="item col-12">
                                                    ...
                                                    <p class="text" id="details_keywords_text">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="item col-12">
                                                    ...
                                                    <p class="text" id="details_intro_text">
                                                        incididunt ut labore et dolore magna aliqua. ... The first word, “Lorem,” isn't even a word; instead it's a piece of the word “dolorem,” meaning pain, suffering, or sorrow.incididunt ut labore et dolore magna aliqua. ... The first word, “Lorem,” isn't even a word; instead it's a piece of the word “dolorem,” meaning pain, suffering, or sorrow.incididunt ut labore et dolore magna aliqua. ... The first word, “Lorem,” isn't even a word; instead it's a piece of the word “dolorem,” meaning pain, suffering, or sorrow.
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="item col-12">
                                                    ...
                                                    <p class="text" id="details_addInfo_text">
                                                        incididunt ut labore et dolore magna aliqua. ... The first word, “Lorem,” isn't even a word; instead it's a piece of the word “dolorem,” meaning pain, suffering, or sorrow.incididunt ut labore et dolore magna aliqua. ... The first word, “Lorem,” isn't even a word; instead it's a piece of the word “dolorem,” meaning pain, suffering, or sorrow.incididunt ut labore et dolore magna aliqua. ... The first word, “Lorem,” isn't even a word; instead it's a piece of the word “dolorem,” meaning pain, suffering, or sorrow.
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="item col-12">
                                                    ...
                                                    <p class="text" id="details_reference_text">
                                                        incididunt ut labore et dolore magna aliqua. ... The first word, “Lorem,” isn't even a word; instead it's a piece of the word “dolorem,” meaning pain, suffering, or sorrow.incididunt ut labore et dolore magna aliqua. ... The first word, “Lorem,” isn't even a word; instead it's a piece of the word “dolorem,” meaning pain, suffering, or sorrow.incididunt ut labore et dolore magna aliqua. ... The first word, “Lorem,” isn't even a word; instead it's a piece of the word “dolorem,” meaning pain, suffering, or sorrow.
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="item col-12">
                                                    ...
                                                    <p class="text" id="financial_disclosure">
                                                        incididunt ut labore et dolore magna aliqua. ... The first word, “Lorem,” isn't even a word; instead it's a piece of the word “dolorem,” meaning pain, suffering, or sorrow.incididunt ut labore et dolore magna aliqua. ... The first word, “Lorem,” isn't even a word; instead it's a piece of the word “dolorem,” meaning pain, suffering, or sorrow.incididunt ut labore et dolore magna aliqua. ... The first word, “Lorem,” isn't even a word; instead it's a piece of the word “dolorem,” meaning pain, suffering, or sorrow.
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="item col-12">
                                                    ...
                                                    <p class="text" id="details_ethics_text">
                                                        incididunt ut labore et dolore magna aliqua. ... The first word, “Lorem,” isn't even a word; instead it's a piece of the word “dolorem,” meaning pain, suffering, or sorrow.incididunt ut labore et dolore magna aliqua. ... The first word, “Lorem,” isn't even a word; instead it's a piece of the word “dolorem,” meaning pain, suffering, or sorrow.incididunt ut labore et dolore magna aliqua. ... The first word, “Lorem,” isn't even a word; instead it's a piece of the word “dolorem,” meaning pain, suffering, or sorrow.
                                                    </p>
                                                </div>
                                            </div>
            ...
            @if($_SERVER['REQUEST_URI'] == '/admin/articles/requests')
            <div class="modal-footer">
                <button type="button" class="btn reject-btn article_to_reject">Reject this article</button>
                <button type="button" class="btn approve-btn article_to_approve">Approve this article</button>
            </div>
            @elseif($_SERVER['REQUEST_URI'] == '/admin/articles/published')
            <div class="modal-footer">
                <button type="button" class="btn reject-btn article_to_reject">Reject this article</button>
            </div>
            @endif
        </div>
        <form class="modal-content d-none" id="approve_step">
            {{ csrf_field() }}
            <input name="article_id" id="article_id" type="hidden" value="">
            <div class="modal-header">
                <button type="button" class="back-btn article_to_body">
                    <span><i class="fas fa-arrow-left"></i></span>
                </button>
                <h5 class="modal-title" id="exampleModalLongTitle">Back To Revision</h5>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="item-step col-12">
                                    <h5 class="title">Assign To Data Entry</h5>
                                    <select name="assign_to_dataEntry" class="selectpicker" required>
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="item-step col-12">
                                    <h5 class="title">Assign To Journal</h5>
                                    <select name="assign_to_journal" id="select_journal" class="selectpicker" required>
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="item-step col-12">
                                    <h5 class="title">Assign To Volume</h5>
                                    <select name="assign_to_vol" id="select_volume" class="selectpicker" required>
            ...
            <div class="modal-footer">
                <button type="reset" class="btn reject-btn" data-dismiss="modal">Cancel</button>
                <button type="submit" class="btn approve-btn">Save</button>
            </div>
        </form>
        <form class="modal-content d-none" id="reject_step">
            {{ csrf_field() }}
            <input name="article_id" id="rejected_article_id" type="hidden" value="">
            <div class="modal-header">
                <button type="button" class="back-btn article_to_body">
                    <span><i class="fas fa-arrow-left"></i></span>
                </button>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="item-step col-12">
                                    <h5 class="title">What is the rejection reason?</h5>
                                    <textarea name="rejection_reasion" required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn reject-btn" data-dismiss="modal">Cancel</button>
                <button type="submit" class="btn approve-btn">Send</button>
            </div>
        </form>
    </div>
</div>
