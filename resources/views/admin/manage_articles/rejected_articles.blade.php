...
@section('content')
        <div class="page-header col-12">
            <div class="row">
                ...
                <p>From this section, you will get all the information about all rejected articles</p>
            </div>
        </div>
                        ...
                        <table id="articleRequestsTable" class="display f-14-table">
                            ...
                            <tbody>
                                ...
                                <tr> 
                                    ...
                                    <td>
                                        <p>
                                            <a href="#" onclick="showArticle({{$article}})" data-toggle="modal" data-target="#rejectedArticleModal" class="show-more-btn">Show More</a>
                                        </p>
                                    </td>
                                </tr>
                                @endforeach
        ...
        @include('layouts.inc.admin_rejectedArticle_modal')
@endsection
@section('scripts')
<script>
    ...
    function showArticle(article)
    {
        ...
        $('#rejection_date').text(article.updated_at);
