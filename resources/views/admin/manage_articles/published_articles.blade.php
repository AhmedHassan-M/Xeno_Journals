...
@section('content')
        <div class="page-header col-12">
            <div class="row">
                ...
                <p>From this section, you will get all the information about articles published successfully</p>
            </div>
        </div>
                        ...
                        <table id="articleRequestsTable" class="display f-14-table">
                            ...
                            <tbody>
                                ...
                                <tr> 
                                    ...
                                    <td>
                                        <p>
                                            <a href="#" onclick="showArticle({{$article}})" data-toggle="modal" data-target="#publishedArticleModal" class="btn btn-primary">Details</a>
                                        </p>
                                    </td>
                                </tr>
                                @endforeach
        ...
        @include('layouts.inc.admin_publishedArticle_modal')
@endsection
@section('scripts')
<script>
    ...
    function showArticle(article)
    {
        ...
        $('#publish_date').text(article.published_at);
