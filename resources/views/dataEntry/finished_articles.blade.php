...
@section('content')
                        ...
                        <table id="articleRequestsTable" class="display f-14-table">
                            ...
                            <tbody>
                                ...
                                <tr> 
                                    ...
                                    <td>
                                        <p>{{$article->corresponding_author}}</p>
                                    </td>
                                    <td>
                                        <p>
                                            <a href="#" onclick="showDataEntryArticleNoEdit({{$article}})" data-toggle="modal" data-target="#dataEntryFinishedArticleModal" class="btn btn-primary">Details</a>
                                        </p>
                                    </td>
                                </tr>
                                @endforeach
        ...
        @include('layouts.inc.dataEntry_finishedArticle_modal')
@endsection
<script>
    ...
    function sendToAdmin()
    {
        ...
        $.ajax({
            ...
            url: url,
            success: function (data) {
                window.location.href="/data_entry/InProgress_articles";
            },
            error: function (data) {
                console.log('error');
            }
